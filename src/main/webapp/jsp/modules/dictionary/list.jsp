            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">会议室管理</li>
                        <li class="breadcrumb-item active">会议室列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">会议室列表</h3>
                            ...
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <input type="text" id="indexNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="会议室名" aria-controls="tableId">
                                        </label>
