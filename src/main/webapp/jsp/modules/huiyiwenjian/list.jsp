    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">会议文件管理管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">会议文件管理列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">会议文件管理列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                会议名
                                                <input type="text" id="huiyiNameSearch"  style="width: 120px;" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(huiyiwenjianNameCell);
            ...
            //文件大致简介
        var huiyiwenjianContentCell = document.createElement('td');
        //如果图文详情包含图片
        if (item.huiyiwenjianContent && item.huiyiwenjianContent.indexOf('img') != -1) {
            //暂时只考虑图片+文字 和 文字+图片的情况
            var beginIndex = item.huiyiwenjianContent.indexOf('<img');
            var endIndex = item.huiyiwenjianContent.indexOf('>');
                huiyiwenjianContentCell.innerHTML = item.huiyiwenjianContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
        } else {
            if (item.huiyiwenjianContent != null && item.huiyiwenjianContent != "" && item.huiyiwenjianContent.length >= 11) {
                    huiyiwenjianContentCell.innerHTML = item.huiyiwenjianContent.substring(0, 10) + "...";
            } else {
                    huiyiwenjianContentCell.innerHTML = item.huiyiwenjianContent;
            }
        }
        row.appendChild(huiyiwenjianContentCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("huiyiwenjian/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addhuiyiwenjian", "addhuiyiwenjian");
        window.location.href = "add-or-update.jsp"
    }
