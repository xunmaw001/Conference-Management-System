...
public class YonghuController {
    ...
    */
    ...
    YonghuEntity yonghu = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("username", username));
        ...
        DictionaryEntity dictionaryEntity1 = dictionaryService.selectOne(new EntityWrapper<DictionaryEntity>().eq("dic_code", "role_types").eq("dic_name", "权限类型").eq("code_index", yonghu.getRoleTypes()));
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", dictionaryEntity1.getIndexName());
        R r = R.ok();
        r.put("token", token);
        r.put("role",dictionaryEntity1.getIndexName());
